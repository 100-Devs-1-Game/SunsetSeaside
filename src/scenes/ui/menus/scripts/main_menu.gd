...
@onready var menu_credits: MarginContainer = $menu_root/menu_credits
@onready var menu_delete_confirm: MarginContainer = $menu_root/menu_delete_confirm

enum MenuType { TITLE, LEVELS, SETTINGS, CONFIRMATION, CREDITS }
...
func _open_menu(menu): # rename this!
	...
	match menu:
		MenuType.TITLE: menu_title.visible = true; Gamestate.last_title_menu = Enums.TitlePosition.TITLE; Events.set_title_position.emit(Enums.TitlePosition.TITLE)
		MenuType.LEVELS: menu_levels.visible = true; Gamestate.last_title_menu = Enums.TitlePosition.LEVELS
		MenuType.SETTINGS: menu_settings.visible = true; Gamestate.last_title_menu = Enums.TitlePosition.SETTINGS; Events.set_title_position.emit(Enums.TitlePosition.SETTINGS)
		MenuType.CONFIRMATION: menu_delete_confirm.visible = true
		MenuType.CREDITS: menu_credits.visible = true;
